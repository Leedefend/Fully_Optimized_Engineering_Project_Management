...
class ProjectProject(models.Model):
    ...
    project_type_id = fields.Many2one('project.dictionary', string='项目分类',
        domain="[('type', '=', 'project_type'), ('active', '=', True)]")
    ...
    build_corp_name = fields.Char(string='建设单位', size=200, required=True)
...
"""
    ...
    def action_export_ai_report(self):
        ...
        for rec in self:
            template_path = misc.file_open('Engineering_Project_Management/static/report_template/project_ai_report_sample.docx').name
